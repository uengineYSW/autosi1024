...
import javax.persistence.*;aa
import java.util.List;
import lombok.Data;ew
import java.util.Date;dsada
...
//<<< Clean Arch / Port Method
    public void order(){
        ...
        // mappings goes here
        OrderApplication.applicationContext.getBean(testmodel.external.InventoryService.class)
